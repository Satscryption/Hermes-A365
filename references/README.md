...
Reference material for the `hermes-a365` skill. Each file is a **dated
snapshot** of an external surface (Microsoft Agent 365 CLI, Entra error
codes, blueprint properties, OpenTelemetry vocabulary, Bot Framework
activity shapes, license catalog) — *not* a source of truth.
...
Snapshot date convention: every file carries a top-level
